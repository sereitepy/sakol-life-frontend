...
// Maps each question code to its label, format type, and all answer options
...
export function AnswerRow({ code, value }: { code: string; value: string }) {
  ...
  const choiceText = !isScale && meta.options ? meta.options[value] : undefined
      ...
      <div className='pl-1'>
        {isScale ? (
          ...
          <div className='flex items-start gap-2'>
            <span className='inline-flex items-center justify-center text-[10px] font-extrabold w-5 h-5 rounded bg-primary/10 text-primary border border-primary/20 shrink-0 mt-0.5'>
              {value}
            </span>
          ...
          // Fallback if option letter not found in map
